export const queries = {
    ...
    saveSolicitudPuesto: 'INSERT INTO Solicitudes_Empleo (Tipo_Puesto, Limitaciones, Deseos, SalarioMax, SalarioMin) VALUES (@tipo_puesto, @limitaciones, @deseos, @salario_max, @salario_min)',
    ...
    getAllSolEmpleo: 'SELECT * FROM Solicitud_Empleo',
